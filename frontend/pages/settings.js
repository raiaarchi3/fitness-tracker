    ...
    <div className="min-h-screen" style={{ background: '#0D0D1A' }}>
      <div className="max-w-sm mx-auto px-4 pt-5 pb-28">
        ...
        <button
          ...
          className="w-full py-3.5 rounded-2xl font-semibold mt-4 transition-all hover:opacity-80"
          style={{ background: 'rgba(226,75,74,0.08)', color: '#E24B4A', border: '1px solid rgba(226,75,74,0.2)', fontSize: 14 }}
        >
          Sign Out
        </button>

        <p className="text-center mt-4 mb-2" style={{ color: '#2A2A4A', fontSize: 11 }}>
          Obsidian Lens v2.0 · Built with Next.js + FastAPI
        </p>
